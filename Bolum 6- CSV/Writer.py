...
with open("arabalar.csv","w",newline='')as file:
 #  csv_writer=csv.writer(file)
   ...
   # csv_writer.writerow(["Toyota","Carolla"])
   # csv_writer.writerow(["Mazda","CX-5"])

 #  csv_writer.writerows([["Marka","Model"],["Toyota","Carolla"],["Toyota","Yaris"]])
 ...
 #Hem okuma hem yazma modunda işlem yapma.
 with open("urunler.csv","r+") as file:
     csv_reader=csv.reader(file)
     csv_writer=csv.writer(file)

     next(csv_reader)
     urunler=[[u[0],u[1],u[2],u[3],u[4],u[5]] for u in csv_reader]
